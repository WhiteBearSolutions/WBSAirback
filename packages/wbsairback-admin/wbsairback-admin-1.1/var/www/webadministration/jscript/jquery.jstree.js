	...
	$(function() {
		...
		var u = navigator.userAgent.toLowerCase(),
			...
			css_string = '' + 
				...
				'.jstree a { display:inline-block; line-height:16px; height:16px; color:#749c9c;font: bold 12px Arial,sans-serif; white-space:nowrap; text-decoration:none; padding:1px 2px; margin:0; } ' + 
